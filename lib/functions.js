...
CFonts.say(`||==== M A D E  B Y  A R D A ====||\BUG? HUBUNGI OWNER
COPYRIGHT AUTHOR
© ARDA SAHA ||\===== H A L L O  O W N E R =====||`, {
  font: 'console',
  align: 'center',
  color: 'white'
})
...
module.exports = { sleep, wait, 
weton,week,calender,dateIslamic,
getBuffer, h2k, generateMessageID, banner, getGroupAdmins, getRandom, start, info, success, close }
